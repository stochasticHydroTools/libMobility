...
////////////////DOUBLE PRECISION//////////////////////
#ifdef SINGLE_PRECISION
VECATTR double3 make_double3(nbody_rpy::real4 a){return make_double3(a.x, a.y, a.z);}
#else
VECATTR double3 make_double3(nbody_rpy::real3 a){return make_double3(a.x, a.y, a.z);}
VECATTR double3 make_double3(nbody_rpy::real4 a){return make_double3(a.x, a.y, a.z);}
#endif
