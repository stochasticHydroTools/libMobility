...
MOBILITY_PYTHONIFY_WITH_EXTRA_CODE(SelfMobility,
				   ...
				   "This module ignores hydrodynamic interactions, AKA the mobility matrix is simply (1/(6*pi*eta*a))*I");

//A module that does not use setParametersSolver can pythonify like this instead
